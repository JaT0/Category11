...
namespace UTB.Eshop.Web
{
    public class Startup
    {
        ...
        {
            //nastaveni CultureInfo tak, aby se mena zobrazovala v dolarech ;-)
            var cultInfo = new CultureInfo(CultureInfo.CurrentCulture.Name);
            cultInfo.NumberFormat.CurrencySymbol = "$";
