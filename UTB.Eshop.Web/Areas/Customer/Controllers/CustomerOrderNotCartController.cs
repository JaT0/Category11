    ...
    public class CustomerOrderNotCartController : Controller
    {
        ...
        public double AddOrderItemsToSession(int? productId)
        {
            ...
            if (product != null)
            {
                ...
                product.Bought = product.Bought + 1;
        ...
        public async Task<IActionResult> ApproveOrderInSession()
        {
            ...
            if (HttpContext.Session.IsAvailable)
            {
                ...
                if (orderItems != null)
                {
                    ...
                    {
            Product prodFromDatabase = EshopDbContext.Products.FirstOrDefault(prod => prod.ID == orderItem.Product.ID);

                        prodFromDatabase.Bought = prodFromDatabase.Bought + 1;
